...
\newcommand*{\insertbiblioauthor}{
    ...
    \else
        \printbibliography[heading=fullheading, section=0, filter=papersregistered, title=\bibtitleauthor]
    \fi
}
...
\newcommand*{\insertbiblioexternal}{
    ...
    \else
        \printbibliography[heading=fullheading, keyword=biblioexternal, section=0, title=\bibtitlefull, resetnumbers=true]
