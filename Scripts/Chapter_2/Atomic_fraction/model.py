    ...
    def __init__(
        ...
        if duration == "ns":
            ...
            self.step_size = F.Stepsize(
                ...
                max_stepsize=lambda t: 0.1e-9 if t < 80e-9 else 1e-7,
                dt_min=1e-11,
            )
            ...
            self.step_size = F.Stepsize(
                initial_value=1e-8,
                stepsize_change_ratio=1.05,
                max_stepsize=lambda t: 1e-8 if t < 30e-6 else 1e-6,
                dt_min=1e-11,
            )
            ...
            self.step_size = F.Stepsize(
                initial_value=1e-6,
                stepsize_change_ratio=1.05,
                max_stepsize=lambda t: 1e-5 if t < 10e-3 else 5e-5,
                dt_min=1e-11,
            )
