...
gmsh.model.geo.addPoint(R, L_Cu, 0, 2e-6, 3)  # right top Cu node
gmsh.model.geo.addPoint(R, L_Cu + L_W, 0, 2e-6, 4)  # right top W node
gmsh.model.geo.addPoint(0, L_Cu + L_W, 0, 5e-8, 5)  # left top W node
gmsh.model.geo.addPoint(0, L_Cu, 0, 2e-7, 6)  # left top Cu node
...
gmsh.model.mesh.field.setNumber(bl, "Thickness", 2e-7)
gmsh.model.mesh.field.setNumber(bl, "SizeFar", 1e-7)
