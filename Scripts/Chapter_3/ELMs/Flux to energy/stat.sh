...
filename=STAT_${SLURM_ARRAY_JOB_ID}_${time}s_${q_stat}MW
mkdir ${filename}
...
def q_tot(T, mobile):
    return q_stat-alpha_W * sigma * T ** 4
...
def cooling(T, mobile):
    if q_stat == 10e6:
        ...
        params = {# "freq": q_eqv * (a + b*x+ c*exp(-d*x))
            0:   [1.499e-1, 6.337e-2, 1.444e-1, np.log(3.523e-1)],
            10:  [1.352e-1, 1.171e-2, 1.198e-1, np.log(7.864e-1)],
            20:  [1.340e-1, 8.860e-3, 1.205e-1, np.log(8.476e-1)],
            30:  [1.318e-1, 7.500e-3, 1.213e-1, np.log(8.672e-1)],
            40:  [1.301e-1, 6.640e-3, 1.221e-1, np.log(8.799e-1)],
            50:  [1.287e-1, 6.040e-3, 1.230e-1, np.log(8.889e-1)],
            60:  [1.276e-1, 5.580e-3, 1.241e-1, np.log(8.960e-1)],
            70:  [1.266e-1, 5.220e-3, 1.252e-1, np.log(9.016e-1)],
            80:  [1.258e-1, 4.930e-3, 1.260e-1, np.log(9.064e-1)],
            90:  [1.250e-1, 4.680e-3, 1.219e-1, np.log(9.104e-1)],
            100: [1.243e-1, 4.470e-3, 1.435e-1, np.log(9.138e-1)]}
...
derived_quantities = [F.DerivedQuantities([F.HydrogenFlux(surface=1), 
                                          ...
                                          nb_iterations_between_compute = 25,
