...
my_model.initial_conditions = [
    F.InitialCondition(field=0, value="./results/exp_mobile_re.xdmf", label = 'mobile_concentration', time_step=-1),
    F.InitialCondition(field="1", value="./results/exp_trapped_re.xdmf", label = 'trap_1_concentration', time_step=-1)
]
